            ...
            <div className=" mx-auto flex flex-wrap justify-center -m-4">
                <div className="lg:w-1/3 p-4 md:w-1/2 ">
                    ...
                    <div className="p-6 text-left">
                        <h1 className="title-font text-lg font-bold text-white mb-3">WHAT IS TRADING BOT?</h1>
                        <p className="leading-relaxed font-thin text-slate-400 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae fermentum congue enim dolor sed dictum quam… </p>
                        <div className="flex items-center flex-wrap ">
                        <button className="pri-btn text-white mt-2 font-light focus:outline-none hover:shadow-lg text-lg">Read more</button>
                        </div>
                    </div>
                    </div>
                </div>
