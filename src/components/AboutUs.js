            ...
            <section className="text-white body-font overflow-hidden">
                    ...
                    <div className="lg:w-4/5 border border-gray-500 bg-sky-800/50 py-10 px-5  mx-auto flex flex-wrap items-center rounded-xl">
                        ...
                        <div className=" md:w-1/2 grid items-center grid-cols-2 gap-2 text-left mx-auto">
                            ...
                            <div>
                                <p className="leading-relaxed lg:text-base font-thin">International AIHA Tech Pty.Ltd </p>
                            </div>
                            ...
                            <div className="">
                                <p className="leading-relaxed lg:text-base font-thin">No. 132, Lane 12, Phan Van Truong Street,Vong Hau Ward - Cau Giay District - Hanoi. </p>
                            </div>
                            <div className="col-start-1">
                                <p className="leading-relaxed font-medium">Code:</p>
                            </div>
                            <div className="">
                                <p className="leading-relaxed lg:text-base font-thin">0104097123</p>
                            </div>
