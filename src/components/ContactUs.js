    ...
    return (
        <div className="container-fluid mx-auto px-5 py-24 sm:px-6 lg:px-8">
            ...
            <div className="w-4/5 mx-auto flex flex-wrap justify-center -m-4">
                <div className=" border border-gray-500 bg-sky-800/50 py-10 px-2  mx-auto flex flex-wrap items-center rounded-xl">
                    <div className="lg:w-1/2 md:w-1/2 rounded p-8 flex flex-col md:ml-auto mt-10 md:mt-0">
                    ...
                    <div className="lg:w-1/2 md:w-1/2 md:pr-16 lg:pr-0 pr-0 items-center">
